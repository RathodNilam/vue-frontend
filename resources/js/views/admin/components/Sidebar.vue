<template>
    ...
    >
      ...
      >
        ...
        <div class="sidebar-brand-text mx-3">Good odds LLC</div>
      </router-link>
 ...
 -->
    ...
    <li class="nav-item">
       <router-link class="nav-link" to="/admin/components/book">
          <i class="fas fa-book"></i>
        <span>Book</span></router-link>
    </li>

    <li class="nav-item">
       <router-link class="nav-link" to="/admin/components/contact">
